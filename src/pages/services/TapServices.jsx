...
const { 
  FiDroplet, FiCheckCircle, FiClock, FiShield, FiStar, 
...
const TapServices = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Tap Installation & Repair Southampton | Better Call Wes</title>
        <meta name="description" content="Professional tap installation and repair in Southampton. Kitchen taps, bathroom taps, mixer taps, designer taps. Quality plumbing service." />
        <meta name="keywords" content="tap installation Southampton, tap repair, kitchen taps, bathroom taps, mixer taps, tap replacement" />
      </Helmet>
              ...
              >
                <div className="bg-white text-brand-charcoal p-6 rounded-2xl mb-8 relative shadow-2xl">
                  ...
                  <p className="font-opensans text-lg leading-relaxed">
                    Need new taps or repairs? I provide professional tap services for kitchens and bathrooms 
                    across Southampton.
                  </p>
                ...
                <h1 className="font-montserrat font-bold text-4xl lg:text-5xl mb-6 text-shadow-hero">
                  Tap Installation & Repair Southampton
                </h1>
                
                <p className="font-opensans text-xl text-brand-cream mb-8 leading-relaxed">
                  Professional tap installation and repair services for kitchen and bathroom taps. 
                  Quality workmanship and reliable service.
                </p>

                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    onClick={() => openWhatsApp('Hi Wes! I need help with taps. Can you provide a quote?')}
          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            >
              <h2 className="font-montserrat font-bold text-4xl mb-6">
                Need Tap Installation or Repair?
              </h2>
              <p className="font-opensans text-xl text-brand-cream mb-8 max-w-2xl mx-auto">
                Professional tap services across Southampton. Quality installation and reliable repairs.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => openWhatsApp('Hi Wes! I need tap services. Can you help?')}
                  className="gradient-orange text-white px-8 py-4 rounded-full font-opensans font-bold text-lg uppercase tracking-wide shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 flex items-center justify-center space-x-3"
                >
                  <SafeIcon icon={FiMessageCircle} className="w-6 h-6" />
                  <span>Get Quote</span>
